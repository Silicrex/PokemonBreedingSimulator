...
start_range = 65  # Inclusive range
end_range = 95  # Inclusive range
seed = None  # None = random, or can specify speed
# pylab.ylim(50, 120)  # BE CAREFUL ABOUT SCALE IF YOU ARE CHANGING TARGET_IVS TO ANYTHING LESS THAN 6
